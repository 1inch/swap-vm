...
contract AquaSwapVMRouterDebug is Simulator, SwapVM, AquaOpcodesDebug {
    constructor(address aqua, address weth, string memory name, string memory version, address owner) SwapVM(aqua, weth, name, version, owner) AquaOpcodesDebug(aqua) { }
